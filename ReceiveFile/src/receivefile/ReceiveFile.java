...
public class ReceiveFile
{
    ...
    public static void main(String args[])
    {
        ...
        {
            System.err.println("Problem in connecting with the server. "
                    + "Exiting main.");
            System.exit(1);
        }
        ...
        try
        {
            ...
            {
                System.err.println("Error in reading from the socket. "
                        + "Exiting main.");
                cleanUp();
                System.exit(0);	
            }
        ...
        while(true)
        {
            ...
            {
                System.out.println("Client wishes to terminate the connection. "
                        + "Exiting main.");
                break;
            }
            if(strSend.equals("DL"))
            {
                ...
                try
                {
                    ...
                    int filesize=Integer.parseInt(strRecv);//the size of the
                    //receiving file
