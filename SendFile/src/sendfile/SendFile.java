    ...
    public static void main(String args[])
    {
        ...
        try
        {
            ...
            while(true)
            {
                ...
                t.start();
                workerThreadCount++;
                System.out.println("Client [" + id + "] is now "
                        + "connected. No. of worker threads = " + 
                        workerThreadCount);
                id++;
            }
        }
        ...
        {
                System.err.println("Problem in ServerSocket operation. "
                        + "Exiting main.");
        }
    }
}
...
class WorkerThread implements Runnable
{
    ...
    public WorkerThread(Socket s, int id)
    {
        ...
        {
            System.err.println("Sorry. Cannot manage client [" + id + "] "
                    + "properly.");
        }
    ...
    public void run()
    {
        ...
        while(true)
        {
            try
            {
                if( (str = br.readLine()) != null )
                {
                    if(str.equals("BYE"))
                    {
                        System.out.println("[" + id + "] says: BYE. "
                                + "Worker thread will terminate now.");
                ...
                {
                    System.out.println("[" + id + "] terminated connection. "
                            + "Worker thread will terminate now.");
                    break;
                }
            }
            ...
            {
                System.err.println("Problem in communicating with the "
                        + "client [" + id + "]. Terminating worker thread.");
                break;
            }
        }
